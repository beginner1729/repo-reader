...
#
# Usage: .claude/prompt_chat.sh | pbcopy
...
cat << PEOF
Use the Task tool to invoke the chat_creator_agent subagent to add a repository-focused chat widget to the documentation website.
